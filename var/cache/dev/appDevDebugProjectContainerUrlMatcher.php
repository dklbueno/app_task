...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'sac_index');
            }

            return array (  '_controller' => 'Longevo\\SacBundle\\Controller\\IndexController::indexAction',  '_route' => 'sac_index',);
        }
        not_sac_index:

        // show
        if (0 === strpos($pathinfo, '/show') && preg_match('#^/show/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'show')), array (  '_controller' => 'Longevo\\SacBundle\\Controller\\IndexController::showAction',));
        }
