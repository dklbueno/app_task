...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('lTj0P4Mgp1', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CiJCi9hOTf', 0, 'oXQ6Lr0hX0Y8GW1Md3KbEV', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'app_task', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Longevo/ModelBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Duo/ModelBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Longevo\\ModelBundle\\Entity');
        $c->addDriver($b, 'Duo\\ModelBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('LongevoModelBundle' => 'Longevo\\ModelBundle\\Entity', 'DuoModelBundle' => 'Duo\\ModelBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_40bb116caf56bc875ba955bef7a2bbcffe28d81f0fd446bfa80751085e3c00c2');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('VeesaWpmMs', NULL, 'oXQ6Lr0hX0Y8GW1Md3KbEV', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, 'homepage'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'security_logout'));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.database_users']) ? $this->services['security.user.provider.concrete.database_users'] : $this->getSecurity_User_Provider_Concrete_DatabaseUsersService()) && false ?: '_'}), 'secured_area', $a, $c, $d), 2 => $j, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $i, 'secured_area', $k, $l, array('check_path' => 'security_login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '592c8ad20be281.97938303', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $h, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $i, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $i, 'security_login', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('secured_area', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'security.user.provider.concrete.database_users', 'secured_area', 'security.authentication.form_entry_point.secured_area', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Longevo/SacBundle/Resources/views'), 'LongevoSac');
        $instance->addPath(($this->targetDirs[3].'/src/Longevo/ChamadoBundle/Resources/views'), 'LongevoChamado');
        $instance->addPath(($this->targetDirs[3].'/src/Duo/AtividadeBundle/Resources/views'), 'Atividade');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JeyHLQRGyg', 0, 'oXQ6Lr0hX0Y8GW1Md3KbEV', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'LongevoSacBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Longevo/SacBundle'),
                    'namespace' => 'Longevo\\SacBundle',
                ),
                'LongevoModelBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Longevo/ModelBundle'),
                    'namespace' => 'Longevo\\ModelBundle',
                ),
                'LongevoChamadoBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Longevo/ChamadoBundle'),
                    'namespace' => 'Longevo\\ChamadoBundle',
                ),
                'AtividadeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Duo/AtividadeBundle'),
                    'namespace' => 'Duo\\AtividadeBundle',
                ),
                'DuoModelBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Duo/ModelBundle'),
                    'namespace' => 'Duo\\ModelBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LongevoSacBundle' => 'Longevo\\SacBundle\\LongevoSacBundle',
                'LongevoModelBundle' => 'Longevo\\ModelBundle\\LongevoModelBundle',
                'LongevoChamadoBundle' => 'Longevo\\ChamadoBundle\\LongevoChamadoBundle',
                'AtividadeBundle' => 'Duo\\AtividadeBundle\\AtividadeBundle',
                'DuoModelBundle' => 'Duo\\ModelBundle\\DuoModelBundle',
